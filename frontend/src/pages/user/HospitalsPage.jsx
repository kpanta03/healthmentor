...
export default function HospitalsPage() {
        ...
        async (position) => {
          try {
            const res = await axios.get(
              `http://localhost:8000/api/hospitals/nearby/?lat=${position.coords.latitude}&lon=${position.coords.longitude}`
            );
  ...
  if (loading) {
    return <p className="text-center mt-4">Loading nearby hospitals...</p>;
  }
